...
public abstract class RoundRobinSenderTemplate implements Partitioner {
  static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(RoundRobinSenderTemplate.class);

  public RoundRobinSenderTemplate() throws SchemaChangeException {
  }

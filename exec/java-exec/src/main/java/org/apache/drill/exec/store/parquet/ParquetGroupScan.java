...
public class ParquetGroupScan extends AbstractParquetGroupScan {
  ...
  public ParquetRowGroupScan getSpecificScan(int minorFragmentId) {
    return new ParquetRowGroupScan(getUserName(), formatPlugin, getReadEntries(minorFragmentId), columns, readerConfig, selectionRoot, filter, tableMetadata.getSchema());
  }

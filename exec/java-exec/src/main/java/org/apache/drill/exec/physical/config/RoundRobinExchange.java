...
public class RoundRobinExchange extends AbstractExchange{
  static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(RoundRobinExchange.class);
  ...
  @JsonCreator
  public RoundRobinExchange(@JsonProperty("child") PhysicalOperator child, @JsonProperty("expr") LogicalExpression expr) {
    super(child);
    this.expr = expr;
  }
  ...
  public Sender getSender(int minorFragmentId, PhysicalOperator child) {
    return new RoundRobinSender(receiverMajorFragmentId, child, expr, receiverLocations);
  }
  ...
  protected PhysicalOperator getNewWithChild(PhysicalOperator child) {
    return new RoundRobinExchange(child, expr);
  }
